...
& $adb shell am start -n com.isopro.app/.MainActivity
```
...
4. On desktop browser at `isopro.me`: same broadcast should **not** appear.
...
2. Go to your site login (e.g. `https://isopro.me/login` or local dev URL).
